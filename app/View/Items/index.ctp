...
<html lang="en">
  ...
  <body style="margin-top: 5%;">
    ...
    <div class="container marketing">
      ...
      <hr class="featurette-divider">
      <div class="fb-like" data-href="http://mory.weblike.jp/house_moving_shopping/Items/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true">
      </div>
      <footer>
